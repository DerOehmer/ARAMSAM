...
class SamInference:
    def __init__(
        ...
        amg_config_path=None,
    ):
        #TODO: implement amg parameters via config
...
class Sam2Inference:
    def __init__(
        ...
        if amg_kwargs:
            ...
            self.amg = DefaultAMG(
                self, SAM2AutomaticMaskGenerator(self.predictor)
            )
...
def load_amg_config(amg_config_path: str | None = None) -> dict:
    if amg_config_path is None:
        return None
